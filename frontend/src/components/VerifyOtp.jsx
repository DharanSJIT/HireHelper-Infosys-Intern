      ...
      <div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] w-full max-w-[480px] px-10 py-10 flex flex-col items-center">
        ...
        <form onSubmit={handleVerify} className="w-full flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-[13px] bg-gradient-to-r from-blue-600 to-indigo-600 hover:shadow-lg text-white text-[15px] font-semibold rounded-lg transition"
          >
        ...
        <p className="mt-6 text-sm text-gray-500 text-center">
          ...
          {countdown > 0 ? (
            ...
            <button
              ...
              disabled={resending}
              className="text-blue-600 font-semibold bg-transparent border-none cursor-pointer hover:underline transition"
            >
