          ...
          <div className="p-6 md:p-8">
            ...
            <div className="pl-11">
              <div className={`
                ...
                ${pictureFile ? 'border-blue-300 bg-blue-50/30' : 'border-slate-300 bg-slate-50 hover:bg-slate-100/50 hover:border-blue-400'}
              `}>
                {pictureFile ? (
                  <div className="w-full max-w-sm">
                    <div className="relative rounded-lg overflow-hidden shadow-md border border-slate-200 bg-white">
                      ...
                      <button
                        type="button"
                        onClick={(e) => { e.preventDefault(); setPictureFile(null); }}
