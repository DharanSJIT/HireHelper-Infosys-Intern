    ...
    <div className="min-h-screen bg-[#F7F5F2] flex flex-col md:flex-row font-['DM_Sans'] text-[#1a1a1a]">
      <div className="w-full md:w-[45%] bg-[#111111] flex flex-col justify-between p-14 relative overflow-hidden">
        ...
        <div className="relative z-10 hidden md:block">
          <h2 className="font-['Playfair_Display'] font-normal text-[clamp(32px,3.5vw,46px)] leading-[1.18] text-white mb-5 tracking-[-0.01em]">
            Almost there,<br />
            <em className="italic text-white/50">verify your email.</em>
          </h2>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-12">
        <div className="w-full max-w-[400px]">
          <div className="mb-10">
            <p className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#999] mb-2.5">Email Verification</p>
          ...
          <form onSubmit={handleVerify}>
            <div className="mb-6">
              ...
              <input
                ...
                type="text"
                maxLength="6"
                className="w-full px-4 py-3.5 font-['DM_Sans'] text-base font-normal text-[#111] bg-white border border-[#e0ddd9] rounded-lg outline-none transition-all duration-200 placeholder:text-[#bbb] focus:border-[#111] focus:shadow-[0_0_0_3px_rgba(17,17,17,0.05)] text-center tracking-[0.5em] text-2xl"
                placeholder="000000"
                value={otp}
          ...
          <div className="mt-9 text-sm text-[#888] text-center">
            ...
            {countdown > 0 ? (
              ...
              <button
                ...
                disabled={resending}
                className="text-[#111] font-medium border-b border-[#111]/25 hover:border-[#111] transition-colors duration-200 bg-transparent cursor-pointer disabled:opacity-50"
              >
